...
namespace CyberInfo.Engine
{
    ...
    /// Demonstrates: Predicate&lt;string&gt; delegates, Dictionary&lt;Sentiment, List&lt;string&gt;&gt;.
    /// </summary>
    public class SentimentDetector
    {
        public enum Sentiment { Neutral, Worried, Curious, Frustrated, Happy }

        // Generic Dictionary maps each sentiment to keyword list
        ...
        // Predicate<string> delegate fields (Part 2 requirement)
