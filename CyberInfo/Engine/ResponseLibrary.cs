...
using System.Text;
    ...
    {
        /// <summary>
        /// Random response pools per topic.
        /// Demonstrates: custom delegate, Func&lt;string,string&gt;, Dictionary&lt;string,List&lt;string&gt;&gt;.
        /// </summary>
        public class ResponseLibrary
        {
            // Custom delegate type (Part 2 requirement)
            public delegate string ResponseSelector(string topic);

            // Func<string,string> delegate field (Part 2 requirement)
            ...
            // Generic Dictionary<string, List<string>> — response pools
            private readonly Dictionary<string, List<string>> _pools = new(StringComparer.OrdinalIgnoreCase)
            {
                ["phishing"] = new()
            {
                "🎣  Watch for emails with urgent language like 'Act now!' or 'Your account will be suspended'. Legitimate organisations rarely demand immediate action.",
                ...
                ["scam"] = new()
            {
                ...
                ["privacy"] = new()
            {
                "🔒  Review the privacy settings on every social media account. Limit who can see your posts and contact info.",
                "🔒  Be cautious about personal details shared online — cybercriminals piece together profiles from multiple sources.",
                "🔒  Use a VPN when connecting to public Wi-Fi to encrypt your traffic.",
                "🔒  Read app permissions carefully — a torch app requesting contacts access is a major red flag.",
                ...
                ["malware"] = new()
            {
                ...
                "🦠  Back up your important files regularly. Ransomware is far less devastating with clean backups.",
                ...
                ["social engineering"] = new()
            {
                ...
                "🎭  Pretexting: attackers create convincing backstories ('I'm from head office — we need your password urgently'). Always say no.",
            ...
            // Returns a ResponseSelector delegate bound to a topic (demonstrates custom delegate)
