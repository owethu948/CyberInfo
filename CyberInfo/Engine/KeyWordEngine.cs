...
namespace CyberInfo.Engine
{
    ...
    /// Demonstrates: Func&lt;string,string?&gt;, Predicate&lt;string&gt;, Dictionary&lt;,&gt; generics.
    /// </summary>
    public class KeywordEngine
    {
        // Generic Dictionary<string, string[]> keyword map
        ...
        // Maps pool key -> canonical Topic name
        ...
        // Func<string, string?> delegate fields (Part 2 requirement)
        public readonly Func<string, string?> FindTopicKey;
        public readonly Func<string, string?> FindTopicName;

        // Predicate<string> delegate (Part 2 requirement)
